...
window = tk.Tk()
window.title("FACE ID ATTENDANCE SYSTEM")
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/VAISHNAVI/OneDrive/Desktop/FACE ID attendance system/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\VAISHNAVI\OneDrive\Desktop\FACE ID attendance system\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/VAISHNAVI/OneDrive/Desktop/FACE ID attendance system/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Users\VAISHNAVI\OneDrive\Desktop\FACE ID attendance system\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'vaishnavi':
            if password == 'vaishnavi123':
                ...
                cs = 'C:/Users/VAISHNAVI/OneDrive/Desktop/FACE ID attendance system/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
message = tk.Label(window, text="FACE ID ATTENDANCE SYSTEM", bg="black", fg="white", width=50,
...
AP = tk.Button(window, text="Check Registered students", command=admin_panel, fg="black",
               bg="white", width=19, height=1, activebackground="white", font=('times', 15, ' bold '))
